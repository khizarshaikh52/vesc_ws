  ...
  vesc_msgs__msg__VescImu * ros_message)
{
  // Field name: ypr
  {
    cdr_deserialize_geometry_msgs__msg__Vector3(cdr, &ros_message->ypr);
  }
  ...
  // Field name: compass
  {
    cdr_deserialize_geometry_msgs__msg__Vector3(cdr, &ros_message->compass);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const vesc_msgs__msg__VescImu * ros_message = static_cast<const vesc_msgs__msg__VescImu *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_vesc_msgs__msg__VescImu(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  vesc_msgs__msg__VescImu * ros_message = static_cast<vesc_msgs__msg__VescImu *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_vesc_msgs__msg__VescImu(cdr, ros_message);
}
