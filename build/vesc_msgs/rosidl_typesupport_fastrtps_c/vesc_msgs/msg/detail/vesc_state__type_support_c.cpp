  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const vesc_msgs__msg__VescState * ros_message = static_cast<const vesc_msgs__msg__VescState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_vesc_msgs__msg__VescState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  vesc_msgs__msg__VescState * ros_message = static_cast<vesc_msgs__msg__VescState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_vesc_msgs__msg__VescState(cdr, ros_message);
}
