...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_VescState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: state
  vesc_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.state,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: state
  current_alignment +=
    vesc_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.state, current_alignment);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vesc_msgs
max_serialized_size_key_VescStateStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vesc_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_VescState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
