  ...
  std::ostream & out)
{
  ...
  {
    out << "compass: ";
    to_flow_style_yaml(msg.compass, out);
    out << ", ";
  }
  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: compass
  {
    ...
    out << "compass:\n";
    to_block_style_yaml(msg.compass, out, indentation + 2);
  }
...
inline std::string to_yaml(const VescImu & msg, bool use_flow_style = false)
{
